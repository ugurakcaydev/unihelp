...
export default function Logo() {
  return (
    <div className=" w-full border-b border-b-[color:var(--background-third)]">
      <Link
        to="/"
        className="w-fit text-[color:var(--color-base)]  h-[53px]  flex items-center justify-start hover:bg-[#eff3f41a] transition-colors"
      >
        <div className=" flex items-center justify-start">
          ...
          <h1 className="text-xl  font-bold">UNIHELP</h1>
        </div>
      </Link>
    </div>
  );
